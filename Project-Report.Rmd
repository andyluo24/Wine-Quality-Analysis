...
```{r}
prediction = predict(svm_model, testing_data)
confusion_matrix = table(testing_data$quality, prediction)
correctPred = 0
...
We use the testing data we split above to evaluate our model.

The accuracy for this model is 66.26%.
